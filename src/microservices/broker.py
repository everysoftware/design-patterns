"""
The Broker pattern is an infrastructure pattern. Its main goal is to organize and simplify interactions between different components of the system by using an intermediary
